<?php
/**
Plugin Name: SetMore Custom Book Now Button
Plugin URI: http://wordpress.org/plugins/setmore-custom-book-now-button
Description:  Create SetMore book now buttons - company, staff for FREE SetMore Themes. Nice and easy interface. Insert anywhere in your site - page/post editor, sidebars, template files. 
Version: 1.2
