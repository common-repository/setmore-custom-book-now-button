...
class OTW_Shortcode_Button extends OTW_Shortcodes{
	...
	public function build_shortcode_editor_options(){
		...
		$html .= OTW_Form::text_input( array( 'id' => 'otw-shortcode-element-href', 'label' => $this->get_label( 'Booking page URL' ), 'description' => $this->get_label( 'Short booking page URL' ), 'parse' => $source )  );
		
		$html .= OTW_Form::select( array( 'id' => 'otw-shortcode-element-page_view', 'label' => $this->get_label( 'Booking page view' ), 'description' => $this->get_label( 'Open my Booking Page in a new window/tab, Overlay a Booking Window on top of my website, Wrap up the button on the side of my website/page' ), 'parse' => $source, 'options' => array( '' => $this->get_label( 'no (Default)' ), '_blank' => $this->get_label( 'New Window' ), 'wrapup' => $this->get_label( 'Wrapup Window' ), 'overlay' => $this->get_label( 'Overlay Window' ) ), 'value' => '' )  );
	...
	public function build_shortcode_code( $attributes ){
		...
		if( !$this->has_error ){
			...
			$code .= $this->format_attribute( 'page_view', 'page_view', $attributes );
	...
	public function display_shortcode( $attributes, $content ){
		...
		$pageview = $this->format_attribute( '', 'page_view', $attributes, false, '' );
		
		if( $pageview == 'overlay'){
		    
			$html = '<a id="Setmore_button_iframe" target="_blank" ';
			...
			$html .= $content.'</a>';
				...
				$html .= $content.'</a>';
			}elseif( $pageview == 'wrapup'){
			
				$html = '<a class="wrapup-button" id="Setmore_button_iframe" target="_blank" ';
				$html .= $this->format_attribute( 'href', 'href', $attributes );
